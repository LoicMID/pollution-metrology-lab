...
⚠️ **Important Note:** This project demonstrates the methodologies and algorithms developed during the thesis (calibration strategies, uncertainty quantification, signal processing).  

No confidential industrial data is hosted here.  

All demonstrations use open datasets (e.g., UCI Air Quality, Synthetic Data) or simulated environments. * This is a "sandbox" for validating generic approaches before applying them to real-world sensor networks.
